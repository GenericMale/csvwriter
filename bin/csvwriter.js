...
program
    ...
    .option('-o, --output <csv>', 'write to csv, use - to write to stdout (default)', '-')
    ...
    .option('-U, --no-utf-bom', 'do not write utf bom (0xFEFF or 0xEFBBBF) in csv if encoding is set to utf')
